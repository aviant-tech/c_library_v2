...
#define MAVLINK_MSG_ID_AVIANT_TRN_TEST_DATA 59700
...
#define MAVLINK_MSG_ID_AVIANT_TRN_TEST_DATA_LEN 56
#define MAVLINK_MSG_ID_AVIANT_TRN_TEST_DATA_MIN_LEN 56
#define MAVLINK_MSG_ID_59700_LEN 56
#define MAVLINK_MSG_ID_59700_MIN_LEN 56

#define MAVLINK_MSG_ID_AVIANT_TRN_TEST_DATA_CRC 183
#define MAVLINK_MSG_ID_59700_CRC 183
...
#define MAVLINK_MESSAGE_INFO_AVIANT_TRN_TEST_DATA { \
    ...
    {  { "time_boot_ms", NULL, MAVLINK_TYPE_UINT32_T, 0, 0, offsetof(mavlink_aviant_trn_test_data_t, time_boot_ms) }, \
         ...
         { "angular_velocity_x", NULL, MAVLINK_TYPE_FLOAT, 0, 44, offsetof(mavlink_aviant_trn_test_data_t, angular_velocity_x) }, \
         { "angular_velocity_y", NULL, MAVLINK_TYPE_FLOAT, 0, 48, offsetof(mavlink_aviant_trn_test_data_t, angular_velocity_y) }, \
         { "angular_velocity_z", NULL, MAVLINK_TYPE_FLOAT, 0, 52, offsetof(mavlink_aviant_trn_test_data_t, angular_velocity_z) }, \
         } \
}
#else
#define MAVLINK_MESSAGE_INFO_AVIANT_TRN_TEST_DATA { \
...
static inline uint16_t mavlink_msg_aviant_trn_test_data_pack(uint8_t system_id, uint8_t component_id, mavlink_message_t* msg,
                               uint32_t time_boot_ms, float x, float y, float z, float vx, float vy, float vz, float q1, float q2, float q3, float q4, float angular_velocity_x, float angular_velocity_y, float angular_velocity_z)
{
    ...
    _mav_put_float(buf, 44, angular_velocity_x);
    _mav_put_float(buf, 48, angular_velocity_y);
    _mav_put_float(buf, 52, angular_velocity_z);
...
static inline void mavlink_msg_aviant_trn_test_data_send(mavlink_channel_t chan, uint32_t time_boot_ms, float x, float y, float z, float vx, float vy, float vz, float q1, float q2, float q3, float q4, float angular_velocity_x, float angular_velocity_y, float angular_velocity_z)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    char buf[MAVLINK_MSG_ID_AVIANT_TRN_TEST_DATA_LEN];
    _mav_put_uint32_t(buf, 0, time_boot_ms);
 ...
 */
static inline void mavlink_msg_aviant_trn_test_data_send_buf(mavlink_message_t *msgbuf, mavlink_channel_t chan,  uint32_t time_boot_ms, float x, float y, float z, float vx, float vy, float vz, float q1, float q2, float q3, float q4, float angular_velocity_x, float angular_velocity_y, float angular_velocity_z)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
...
/**
 * @brief Get field angular_velocity_x from aviant_trn_test_data message
 *
 * @return [rad/s] X component of angular velocity
 */
static inline float mavlink_msg_aviant_trn_test_data_get_angular_velocity_x(const mavlink_message_t* msg)
{
    return _MAV_RETURN_float(msg,  44);
}

/**
 * @brief Get field angular_velocity_y from aviant_trn_test_data message
 *
 * @return [rad/s] Y component of angular velocity
 */
static inline float mavlink_msg_aviant_trn_test_data_get_angular_velocity_y(const mavlink_message_t* msg)
{
    return _MAV_RETURN_float(msg,  48);
}

/**
 * @brief Get field angular_velocity_z from aviant_trn_test_data message
 *
 * @return [rad/s] Z component of angular velocity
 */
static inline float mavlink_msg_aviant_trn_test_data_get_angular_velocity_z(const mavlink_message_t* msg)
{
...
static inline void mavlink_msg_aviant_trn_test_data_decode(const mavlink_message_t* msg, mavlink_aviant_trn_test_data_t* aviant_trn_test_data)
{
    ...
    aviant_trn_test_data->angular_velocity_x = mavlink_msg_aviant_trn_test_data_get_angular_velocity_x(msg);
    aviant_trn_test_data->angular_velocity_y = mavlink_msg_aviant_trn_test_data_get_angular_velocity_y(msg);
    aviant_trn_test_data->angular_velocity_z = mavlink_msg_aviant_trn_test_data_get_angular_velocity_z(msg);
#else
